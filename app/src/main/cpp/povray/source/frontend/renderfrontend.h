...
class RenderFrontend : public RenderFrontendBase
{
	...
	public:
		...
		SceneId CreateScene(POVMSAddress backendaddress, POVMS_Object& obj, std::function<Console *()> fn);
		...
		ViewId CreateView(SceneId sid, POVMS_Object& obj, shared_ptr<ImageProcessing>& imageProcessing, std::function<Display *(unsigned int, unsigned int, GammaCurvePtr)> fn);
...
template<class PARSER_MH, class FILE_MH, class RENDER_MH, class IMAGE_MH>
RenderFrontendBase::SceneId RenderFrontend<PARSER_MH, FILE_MH, RENDER_MH, IMAGE_MH>::CreateScene(POVMSAddress backendaddress, POVMS_Object& obj, std::function<Console*()> fn)
{
	SceneHandler sh;
	SceneId sid;
...
template<class PARSER_MH, class FILE_MH, class RENDER_MH, class IMAGE_MH>
RenderFrontendBase::ViewId RenderFrontend<PARSER_MH, FILE_MH, RENDER_MH, IMAGE_MH>::CreateView(SceneId sid, POVMS_Object& obj, shared_ptr<ImageProcessing>& imageProcessing, std::function<Display *(unsigned int,unsigned int,GammaCurvePtr)> fn)
{
	typename std::map<SceneId, SceneHandler>::iterator shi(scenehandler.find(sid));
