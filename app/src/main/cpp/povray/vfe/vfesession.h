...
namespace vfe
{
  ...
  class IOPath
  {
    public:
      ...
      // construct an IOPath given a string path and a recursion flag.
  ...
  class vfeSession
  {
    ...
    public:
      ...
      typedef std::function<vfeDisplay *(unsigned int, unsigned int, GammaCurvePtr, vfeSession *session, bool)> DisplayCreator;
      typedef enum
      {
        mUnclassified = 0,
        mDebug,
    ...
    protected:
      ...
      std::condition_variable_any m_SessionEvent;
      std::mutex m_InitializeMutex;
      std::condition_variable_any m_InitializeEvent;
      std::condition_variable_any m_ShutdownEvent;
      ...
      std::condition_variable_any m_RequestEvent;
